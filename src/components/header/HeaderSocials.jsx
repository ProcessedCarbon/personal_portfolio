  ...
  return (
    <div className="header_socials">
        <div className="linked-in">
          <a href="https://www.linkedin.com/in/gregory-wong-9692b115a/" target="_blank" className='linkedin-icon'><BsLinkedin/></a>
          <h5 className='tool-tip'>LinkedIn</h5>
        </div>
        <div className="instagram">
          <a href="https://www.instagram.com/gregory_w0ng/" target="_blank" className='instagram-icon'><AiOutlineInstagram/></a>
